...
def Introduction():
    ...
    try:
        driver.find_element(by=By.XPATH,value="/html[1]/body[1]/div[1]/main[1]/div[1]/div[1]/div[3]/div[1]/div[4]/div[1]/div[1]/textarea[1]").send_keys("Hello")

    except:
        driver.find_element(by=By.XPATH,value="/html[1]/body[1]/div[1]/main[1]/div[1]/div[1]/div[3]/div[1]/div[4]/div[1]/div[1]/textarea[1]").send_keys("Hello")

    sleep(1)
    driver.find_element(by=By.XPATH,value="/html[1]/body[1]/div[1]/main[1]/div[1]/div[1]/div[3]/div[1]/div[4]/div[1]/button[2]/*[name()='svg'][1]").click()
    sleep(1)
    driver.find_element(by=By.XPATH,value="/html[1]/body[1]/div[1]/main[1]/div[1]/div[1]/div[3]/div[1]/div[4]/div[1]/button[2]/*[name()='svg'][1]").click()
    sleep(1)
    ...
    FileHistory = open("Brain\\DataBase/Pi-Ai_Chatlog/chatNumberPi.txt","w")
    FileHistory.write('1')
    FileHistory.close()
    FileReadNow = open("Brain\\DataBase/Pi-Ai_Chatlog/piHistory.txt","w")
    FileReadNow.write('1')
    FileReadNow.close()
...
def AnswerReturn(Query):
    ...
    while True:
        ...
        if True==SendButton:
            ...
            FileHistory = open("D:\MyData\Documents\CODING\Python\Jarvis\DataBase\Pi-Ai_Chatlog\piHistory.txt","w")
            FileHistory.write('1')
            FileHistory.close()
            ...
            FileRead = open("Brain\\DataBase/Pi-Ai_Chatlog/chatNumberPi.txt","r")
            Data = FileRead.read()
            FileRead.close()
...
while True:
    ...
    # sleep(3)
    # Query = Listen()
    File = open("Brain\\DataBase/Pi-Ai_Chatlog/piHistory.txt","r")
    DataRead = File.read()
    File.close()
